...
export default class Resources extends React.Component {
    render() {
        let root_page_path = _.get(this.props, 'pageContext.site.data.resources.root_folder') + 'index.md';
              ...
              <div className="outer">
                <div className="inner">
                  <div className="docs-content">
                    <ResourcesMenu {...this.props} page={this.props.pageContext} site={this.props.pageContext.site} />
