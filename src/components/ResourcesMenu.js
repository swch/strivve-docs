...
export default class ResourcesMenu extends React.Component {
    render() {
        ...
        let root_page_path = _.get(site, 'data.resources_sections.root_folder') + 'index.md';
              ...
              <div id="docs-nav-inside" className="docs-nav-inside sticky">
                ...
                <div className="docs-toc-wrap">
                  <ul id="docs-toc" className="docs-toc">
                    ...
                    {_.map(_.get(site, 'data.resources_sections.sections'), (section, section_idx) => {
                        let section_folder = _.get(site, 'data.resources_sections.root_folder') + section;
