...
export default class GuidesMenu extends React.Component {
    render() {
        let site = _.get(this.props, 'site');
        let page = _.get(this.props, 'page');
        let root_page_path = _.get(site, 'data.guides_sections.root_folder') + 'index.md';
              ...
              <div id="docs-nav-inside" className="docs-nav-inside sticky">
                ...
                <div className="docs-toc-wrap">
                  <ul id="docs-toc" className="docs-toc">
                    ...
                    {_.map(_.get(site, 'data.guides_sections.sections'), (section, section_idx) => {
                        let section_folder = _.get(site, 'data.guides_sections.root_folder') + section;
